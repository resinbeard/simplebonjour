...
PDROOT=/home/mfoster/apps/Pd-0.41.4-extended/pd

# here we find the sources of pd (and evtl. the pd.lib)
PDSRCDIR=$/home/mfoster/apps/Pd-0.41.4-extended/pd/src
PDLIBDIR=$/home/mfoster/apps/Pd-0.41.4-extended/pd/bin
...
LINUXINCLUDE =  -I$(PDSRCDIR) -ldns_sd
